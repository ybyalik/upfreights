...
export default function SeaFreightChinaToUKPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Cost-effective ocean shipping with FCL and LCL options from major Chinese ports to UK destinations.
                Expert handling of post-Brexit customs requirements included.
              </p>
      ...
      <section className="py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-ocean mb-1">28-35</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Sea Freight to the UK?
              </h2>
              <p className="text-muted-foreground mb-8">
                Sea freight is the most economical way to ship from China to the United Kingdom.
                Our team has extensive experience navigating post-Brexit customs requirements,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We ship to all major UK ports with excellent inland distribution networks.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Sea Freight Routes to UK
            </h2>
            <p className="text-muted-foreground">
              Browse all {seaRoutes.length} sea freight routes from China to the United Kingdom.
            </p>
          </div>
