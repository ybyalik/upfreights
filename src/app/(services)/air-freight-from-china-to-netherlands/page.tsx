...
export const metadata: Metadata = {
  title: 'Air Freight from China to Netherlands | Express Air Cargo Services',
  description: 'Fast air freight services from China to Netherlands. Express and standard air cargo options with 3-5 day delivery to Amsterdam Schiphol Airport.',
  alternates: {
    canonical: '/air-freight-from-china-to-netherlands',
  },
  openGraph: {
    title: 'Air Freight from China to Netherlands | UpFreights',
    description: 'Fast air freight services from China to Netherlands via Schiphol Airport.',
  },
};

const whyChooseAirFreight = [
  'Fast delivery - 3-5 days to Amsterdam Schiphol',
  'Europe\'s third largest cargo airport',
  'Ideal for high-value and perishable goods',
  'Excellent European distribution network',
  '24/7 cargo operations at Schiphol',
];

const majorAirports = [
  { name: 'Amsterdam Schiphol (AMS)', transit: '3-5 days', hub: "Europe's Cargo Gateway" },
];

export default function AirFreightChinaToNetherlandsPage() {
  // Note: Netherlands may have limited air routes in the generator
  // since most routes go to London for UK air traffic
  ...
  const hasRoutes = airRoutes.length > 0;
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Fast and reliable air cargo services from China to Amsterdam Schiphol.
                Europe&apos;s third largest cargo airport with excellent distribution throughout the EU.
              </p>
      ...
      <section className="py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-orange mb-1">24/7</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Air Freight to Netherlands?
              </h2>
              <p className="text-muted-foreground mb-8">
                Amsterdam Schiphol is Europe&apos;s third-largest cargo airport, specializing in
                high-value goods, perishables, and pharmaceuticals. Its strategic location
                makes it an ideal hub for European distribution.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Dutch Destination Airport
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Amsterdam Schiphol is one of Europe&apos;s premier cargo airports.
            </p>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
                All Air Freight Routes to Netherlands
              </h2>
              <p className="text-muted-foreground">
                Browse all {airRoutes.length} air freight routes from China to the Netherlands.
              </p>
            </div>
      ...
      {/* Contact for Routes Section - shows if no routes */}
      {!hasRoutes && (
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Custom Air Freight Solutions
              </h2>
              <p className="text-muted-foreground mb-8">
                We offer air freight to Amsterdam Schiphol from all major Chinese airports.
                Contact us for a custom quote tailored to your shipment needs.
              </p>
              <Button asChild className="bg-orange hover:bg-orange-dark text-white">
                <Link href="/quote">
                  Get Custom Quote
      ...
      <CTASection
        variant="gradient"
        title="Ship by Air to Netherlands Today"
        description="Get a free quote for air freight from China to Netherlands. Schiphol - your European cargo gateway."
      />
    </>
  );
}
