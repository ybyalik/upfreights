      ...
      <section className="py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-ocean mb-1">9</div>
              ...
              <div key={destination} id={`routes-${destination.toLowerCase().replace(/\s+/g, '-')}`} className="scroll-mt-24">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  ...
                  {[
                    ...
                    routes.filter(r => r.originCity === subPort.parentCity).map((route) => (
                      <Link
                      ...
                      >
                        ...
                        <div className="font-medium text-foreground group-hover:text-ocean transition-colors">
                          {subPort.name} &rarr; {route.destinationCity}
                        </div>
                        <div className="text-xs text-muted-foreground mt-1">
                          {route.frequency}
                        </div>
