...
export const metadata: Metadata = {
  title: 'Air Freight from China to Canada | Express Air Cargo Services',
  description: 'Fast air freight services from China to Canada. Express and standard air cargo options with 2-4 day delivery to Toronto, Vancouver, Montreal, and more.',
  alternates: {
    canonical: '/air-freight-from-china-to-canada',
  },
  openGraph: {
    title: 'Air Freight from China to Canada | UpFreights',
    description: 'Fast air freight services from China to Canada with 2-4 day delivery.',
  },
};

const whyChooseAirFreight = [
  'Fastest delivery option - 2-4 days to most Canadian destinations',
  ...
  'CBSA compliant customs clearance',
];

const majorAirports = [
  { name: 'Toronto (YYZ)', transit: '3-4 days', hub: 'Eastern Canada Hub' },
  { name: 'Vancouver (YVR)', transit: '2-3 days', hub: 'Pacific Gateway' },
  { name: 'Montreal (YUL)', transit: '3-4 days', hub: 'Quebec Hub' },
  { name: 'Calgary (YYC)', transit: '2-3 days', hub: 'Alberta Hub' },
  { name: 'Ottawa (YOW)', transit: '3-4 days', hub: 'Capital Region' },
];

export default function AirFreightChinaToCanadaPage() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Fast and reliable air cargo services from China to Canada.
                Express delivery in 2-4 days with daily flights from major Chinese airports.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Air Freight to Canada?
              </h2>
              <p className="text-muted-foreground mb-8">
                Air freight is the fastest way to ship from China to Canada.
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Major Canadian Destination Airports
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We deliver to all major Canadian airports with connections to any final destination.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Air Freight Routes to Canada
            </h2>
            <p className="text-muted-foreground">
              Browse all {airRoutes.length} air freight routes from China to Canada.
            </p>
          </div>
      ...
      <CTASection
        variant="gradient"
        title="Ship by Air to Canada Today"
        description="Get a free quote for air freight from China to Canada. Fast delivery, competitive rates, and expert handling."
      />
    </>
  );
}
