...
export const metadata: Metadata = {
  title: 'Air Freight from China to Germany | Express Air Cargo Services',
  description: 'Fast air freight services from China to Germany. Express and standard air cargo options with 3-5 day delivery to Frankfurt, Munich, Hamburg, and more.',
  alternates: {
    canonical: '/air-freight-from-china-to-germany',
  },
  openGraph: {
...
const whyChooseAirFreight = [
  'Fastest delivery option - 3-5 days to most German cities',
  'Ideal for time-sensitive and high-value shipments',
  'Express, standard, and economy service tiers',
  'Daily flights to Frankfurt - Europe\'s busiest cargo hub',
  'EU customs clearance expertise included',
];

const majorAirports = [
  { name: 'Frankfurt (FRA)', transit: '3-4 days', hub: "Europe's Cargo Hub" },
  { name: 'Munich (MUC)', transit: '3-5 days', hub: 'Southern Germany' },
  { name: 'Leipzig (LEJ)', transit: '3-5 days', hub: 'DHL European Hub' },
  { name: 'Hamburg (HAM)', transit: '3-5 days', hub: 'Northern Gateway' },
];

export default function AirFreightChinaToGermanyPage() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Fast and reliable air cargo services from China to Germany.
                Express delivery in 3-5 days with daily flights to Frankfurt and Munich.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Air Freight to Germany?
              </h2>
              <p className="text-muted-foreground mb-8">
                Germany is Europe&apos;s manufacturing powerhouse and a key trading partner with China.
                Frankfurt Airport is Europe&apos;s busiest cargo hub, ensuring excellent connectivity
                and competitive rates for air freight shipments.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Major German Destination Airports
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We deliver to all major German airports with excellent European distribution.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Air Freight Routes to Germany
            </h2>
            <p className="text-muted-foreground">
              Browse all {airRoutes.length} air freight routes from China to Germany.
            </p>
          </div>
      ...
      <CTASection
        variant="gradient"
        title="Ship by Air to Germany Today"
        description="Get a free quote for air freight from China to Germany. Fast delivery with EU customs expertise."
      />
    </>
  );
}
