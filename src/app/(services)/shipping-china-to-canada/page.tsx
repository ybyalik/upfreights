...
const COUNTRY_SLUG = 'shipping-china-to-canada';

export default function ShippingToCanadaPage() {
  // Get routes for Canada
  ...
  const country = getCountryBySlug(COUNTRY_SLUG);
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Ship to Canada with Us?
              </h2>
              <p className="text-muted-foreground mb-8">
                We specialize in freight forwarding from China to Canada, offering both air and sea freight options to meet your specific shipping requirements. Our extensive network and experience ensure your cargo reaches its destination safely and on time.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-hero rounded-2xl p-8 lg:p-12">
                <div className="space-y-6">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div className="text-5xl font-bold text-orange mb-2">2-6</div>
                    <div className="text-white/80">Days Air Freight</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div className="text-5xl font-bold text-white mb-2">12-20</div>
            ...
            <Card className="border-border/50">
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-foreground">Air Freight to Canada</h3>
                    <p className="text-sm text-muted-foreground">Fast and reliable air cargo services</p>
                  </div>
                </div>

                <p className="text-muted-foreground mb-6">
                  Fast and reliable air cargo services from major Chinese airports to Canada. Perfect for time-sensitive and high-value shipments.
                </p>

                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                    <span className="text-muted-foreground">Transit Time:</span>
                    <span className="font-semibold text-foreground">2-6 days</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                ...
                <div className="flex items-center justify-between">
                  <Button asChild variant="outline">
                    <Link href="/air-freight-from-china-to-canada">
                      View Air Freight to Canada
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Link>
                  </Button>
                  <span className="text-sm text-muted-foreground">Starting from <span className="font-semibold text-orange">$5.20/kg</span></span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50">
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-foreground">Sea Freight to Canada</h3>
                    <p className="text-sm text-muted-foreground">Cost-effective ocean shipping</p>
                  </div>
                </div>

                <p className="text-muted-foreground mb-6">
                  Cost-effective ocean shipping with FCL and LCL options from Chinese ports to Canada. Ideal for large volumes and non-urgent cargo.
                </p>

                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                    <span className="text-muted-foreground">Transit Time:</span>
                    <span className="font-semibold text-foreground">12-20 days</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                    <span className="text-muted-foreground">Available Routes:</span>
                ...
                <div className="flex items-center justify-between">
                  <Button asChild variant="outline">
                    <Link href="/sea-freight-from-china-to-canada">
                      View Sea Freight to Canada
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Link>
                  </Button>
                  <span className="text-sm text-muted-foreground">Starting from <span className="font-semibold text-ocean">$50/CBM</span></span>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Routes to Canada
            </h2>
            <p className="text-muted-foreground">
              Browse all {seaRoutes.length + airRoutes.length} shipping routes from China to Canada.
      ...
      <CTASection
        variant="gradient"
        title="Ship to Canada Today"
        description="Get a free quote for shipping from China to Canada. Our team will help you choose the best option."
      />
    </>
  );
}
