...
export const metadata: Metadata = {
  title: 'Air Freight from China to Australia | Express Air Cargo Services',
  description: 'Fast air freight services from China to Australia. Express and standard air cargo options with 2-4 day delivery to Sydney, Melbourne, Brisbane, and Perth.',
  alternates: {
    canonical: '/air-freight-from-china-to-australia',
  },
  openGraph: {
    title: 'Air Freight from China to Australia | UpFreights',
    description: 'Fast air freight services from China to Australia with 2-4 day delivery.',
  },
};

const whyChooseAirFreight = [
  'Fastest delivery option - 2-4 days to most Australian cities',
  'Ideal for time-sensitive and high-value shipments',
  'Express, standard, and economy service tiers',
  'Daily flights to Sydney and Melbourne',
  'Biosecurity pre-clearance available',
];

const majorAirports = [
  { name: 'Sydney (SYD)', transit: '2-3 days', hub: 'Primary Australian Hub' },
  { name: 'Melbourne (MEL)', transit: '2-3 days', hub: 'Victoria Gateway' },
  { name: 'Brisbane (BNE)', transit: '2-3 days', hub: 'Queensland Hub' },
  { name: 'Perth (PER)', transit: '2-3 days', hub: 'Western Australia' },
  { name: 'Canberra (CBR)', transit: '3-4 days', hub: 'Capital Territory' },
];

export default function AirFreightChinaToAustraliaPage() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Fast and reliable air cargo services from China to Australia.
                Express delivery in 2-4 days with daily flights to all major Australian airports.
              </p>
      ...
      <section className="py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-orange mb-1">2-4</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Air Freight to Australia?
              </h2>
              <p className="text-muted-foreground mb-8">
                Air freight from China to Australia offers excellent transit times due to
                the relatively short distance. Perfect for e-commerce, urgent shipments,
                and perishable goods. Our team ensures compliance with Australia&apos;s strict biosecurity requirements.
              </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-secondary/50 rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">2-3 days • Regular handling</div>
                      <div className="text-sm text-orange mt-1">Best value for most shipments</div>
                    </div>
                    <div className="p-4 bg-secondary/50 rounded-lg">
                      <div className="font-medium">Economy Air</div>
                      <div className="text-sm text-muted-foreground">3-4 days • Consolidated cargo</div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Major Australian Destination Airports
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We deliver to all major Australian airports with domestic connections available.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Air Freight Routes to Australia
            </h2>
            <p className="text-muted-foreground">
              Browse all {airRoutes.length} air freight routes from China to Australia.
            </p>
          </div>
      ...
      <CTASection
        variant="gradient"
        title="Ship by Air to Australia Today"
        description="Get a free quote for air freight from China to Australia. Fast delivery with biosecurity compliance included."
      />
    </>
  );
}
