...
export const metadata: Metadata = {
  title: 'Sea Freight from China to Netherlands | Ocean Shipping Services',
  description: 'Reliable sea freight services from China to Netherlands. FCL and LCL shipping with 26-32 days transit to Rotterdam - Europe\'s largest port.',
  alternates: {
    canonical: '/sea-freight-from-china-to-netherlands',
  },
  openGraph: {
    title: 'Sea Freight from China to Netherlands | UpFreights',
    description: 'Reliable sea freight services from China to Netherlands via Rotterdam.',
  },
};

const whyChooseSeaFreight = [
  'Direct access to Rotterdam - Europe\'s largest port',
  'FCL (Full Container Load) and LCL (Less than Container Load) options',
  'Ideal gateway for European distribution',
  'Excellent barge and rail connections throughout EU',
  'Bonded warehousing options available',
];

const majorPorts = [
  { name: 'Rotterdam', transit: '28-32 days', volume: "Europe's largest port" },
  { name: 'Amsterdam', transit: '28-32 days', volume: 'Secondary port option' },
];

export default function SeaFreightChinaToNetherlandsPage() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Ship to Europe&apos;s largest port - Rotterdam. The perfect gateway for European distribution
                with excellent barge and rail connections to all EU countries.
              </p>
      ...
      <section className="py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-ocean mb-1">26-32</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Sea Freight to Netherlands?
              </h2>
              <p className="text-muted-foreground mb-8">
                Rotterdam is Europe&apos;s premier gateway port, handling over 14 million TEUs annually.
                Its strategic location and excellent inland connections make it the ideal entry point
                for cargo destined anywhere in Europe.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Dutch Destination Ports
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Rotterdam is the primary gateway with excellent connections to all of Europe.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Sea Freight Routes to Netherlands
            </h2>
            <p className="text-muted-foreground">
              Browse all {seaRoutes.length} sea freight routes from China to the Netherlands.
            </p>
          </div>
      ...
      <CTASection
        variant="gradient"
        title="Ship by Sea to Netherlands Today"
        description="Get a free quote for sea freight from China to Netherlands. Rotterdam - your gateway to Europe."
      />
    </>
  );
}
