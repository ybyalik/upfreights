...
import { Plane, CheckCircle, ArrowRight, Clock, Zap } from 'lucide-react';
...
export const metadata: Metadata = {
  title: 'Air Freight from China to USA | Express Air Cargo Services',
  description: 'Fast air freight services from China to USA. Express and standard air cargo options with 2-5 day delivery to all major US airports.',
  alternates: {
    canonical: '/air-freight-from-china-to-usa',
  },
  openGraph: {
    title: 'Air Freight from China to USA | UpFreights',
    description: 'Fast air freight services from China to USA with 2-5 day delivery.',
  },
};

const whyChooseAirFreight = [
  'Fastest delivery option - 2-5 days to most US destinations',
  'Ideal for time-sensitive and high-value shipments',
  'Express, standard, and economy service tiers',
  'Daily flights from major Chinese airports',
  'Real-time tracking and priority handling',
];

const majorAirports = [
  { name: 'Los Angeles (LAX)', transit: '2-3 days', hub: 'West Coast Hub' },
  { name: 'New York (JFK)', transit: '3-4 days', hub: 'East Coast Gateway' },
  { name: 'Chicago (ORD)', transit: '3-4 days', hub: 'Midwest Hub' },
  { name: 'Atlanta (ATL)', transit: '3-4 days', hub: 'Southeast Hub' },
  { name: 'San Francisco (SFO)', transit: '2-3 days', hub: 'Tech Corridor' },
];

export default function AirFreightChinaToUSAPage() {
  // Get air routes for United States only
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Fast and reliable air cargo services from China to the United States.
                Express delivery in 2-5 days with daily flights from major Chinese airports.
              </p>
      ...
      <section className="py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-orange mb-1">2-5</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Air Freight to the USA?
              </h2>
              <p className="text-muted-foreground mb-8">
                Air freight is the fastest way to ship from China to the United States.
                Perfect for urgent shipments, high-value goods, and time-sensitive inventory replenishment.
                Our partnerships with major airlines ensure competitive rates and reliable schedules.
              </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-secondary/50 rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">1-2 days • Priority handling</div>
                      <div className="text-sm text-orange mt-1">For urgent shipments</div>
                    </div>
                    <div className="p-4 bg-secondary/50 rounded-lg">
                      <div className="font-medium">Standard Air Cargo</div>
                      <div className="text-sm text-muted-foreground">2-4 days • Regular handling</div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Major US Destination Airports
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We deliver to all major US airports with connections to any final destination.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Air Freight Routes to USA
            </h2>
            <p className="text-muted-foreground">
              Browse all {airRoutes.length} air freight routes from China to the United States.
            </p>
          </div>
      ...
      <CTASection
        variant="gradient"
        title="Ship by Air to the USA Today"
        description="Get a free quote for air freight from China to the USA. Fast delivery, competitive rates, and expert handling."
      />
    </>
  );
}
