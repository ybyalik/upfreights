...
export const metadata: Metadata = {
  title: 'Shipping from China to Australia | UpFreights',
  ...
  alternates: {
    canonical: '/shipping-china-to-australia',
  },
  openGraph: {
    title: 'Shipping from China to Australia | UpFreights',
    description: 'Sea and air freight from China to Australia. 14-22 day transit to Sydney, Melbourne, Brisbane, and Fremantle. FCL, LCL, and door-to-door delivery.',
  ...
  twitter: {
    ...
    title: 'Shipping from China to Australia | UpFreights',
    description: 'Sea and air freight from China to Australia. 14-22 day transit. FCL, LCL, and door-to-door delivery.',
    images: ['/og-image.png'],
  },
};
...
export default function ShippingToAustraliaPage() {
  ...
  const country = getCountryBySlug('shipping-china-to-australia');
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Ship to Australia with Us?
              </h2>
              <p className="text-muted-foreground mb-8">
                We specialize in freight forwarding from China to Australia, offering both air and sea freight options to meet your specific shipping requirements. Our extensive network and experience ensure your cargo reaches its destination safely and on time.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-hero rounded-2xl p-8 lg:p-12">
                <div className="space-y-6">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div className="text-5xl font-bold text-orange mb-2">3-7</div>
                    <div className="text-white/80">Days Air Freight</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div className="text-5xl font-bold text-white mb-2">18-28</div>
            ...
            <Card className="border-border/50">
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-foreground">Air Freight to Australia</h3>
                    <p className="text-sm text-muted-foreground">Fast and reliable air cargo services</p>
                  </div>
                </div>

                <p className="text-muted-foreground mb-6">
                  Fast and reliable air cargo services from major Chinese airports to Australia. Perfect for time-sensitive and high-value shipments.
                </p>

                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                    <span className="text-muted-foreground">Transit Time:</span>
                    <span className="font-semibold text-foreground">3-7 days</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">Starting from <span className="font-semibold text-orange">$7.20/kg</span></span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50">
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-foreground">Sea Freight to Australia</h3>
                    <p className="text-sm text-muted-foreground">Cost-effective ocean shipping</p>
                  </div>
                </div>

                <p className="text-muted-foreground mb-6">
                  Cost-effective ocean shipping with FCL and LCL options from Chinese ports to Australia. Ideal for large volumes and non-urgent cargo.
                </p>

                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                    <span className="text-muted-foreground">Transit Time:</span>
                    <span className="font-semibold text-foreground">18-28 days</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                    <span className="text-muted-foreground">Available Routes:</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">Starting from <span className="font-semibold text-ocean">$75/CBM</span></span>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Routes to Australia
            </h2>
            <p className="text-muted-foreground">
              Browse all {seaRoutes.length + airRoutes.length} shipping routes from China to Australia.
      ...
      <CTASection
        variant="gradient"
        title="Ship to Australia Today"
        description="Get a free quote for shipping from China to Australia. Our team will help you choose the best option."
      />
    </>
  );
}
