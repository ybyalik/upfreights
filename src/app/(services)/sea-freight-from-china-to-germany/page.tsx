...
export const metadata: Metadata = {
  title: 'Sea Freight from China to Germany | Ocean Shipping Services',
  description: 'Reliable sea freight services from China to Germany. FCL and LCL shipping with 28-40 days transit to Hamburg, Bremerhaven, and other German ports.',
  alternates: {
    canonical: '/sea-freight-from-china-to-germany',
  },
  openGraph: {
    title: 'Sea Freight from China to Germany | UpFreights',
    description: 'Reliable sea freight services from China to Germany with FCL and LCL options.',
  },
};
...
const whyChooseSeaFreight = [
  ...
  'Direct services to Hamburg - Europe\'s third largest port',
  'Rail freight alternative via China-Europe Express available',
  'EU customs compliance expertise included',
];

const majorPorts = [
  { name: 'Hamburg', transit: '30-35 days', volume: "Germany's largest port" },
  { name: 'Bremerhaven', transit: '30-35 days', volume: 'Major automotive hub' },
  { name: 'Wilhelmshaven', transit: '30-35 days', volume: 'Deep-water port' },
  { name: 'Frankfurt', transit: '32-38 days', volume: 'Inland via Hamburg' },
  { name: 'Munich', transit: '33-40 days', volume: 'Southern Germany hub' },
];

export default function SeaFreightChinaToGermanyPage() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Cost-effective ocean shipping from China to Germany, Europe&apos;s largest economy.
                Direct services to Hamburg and Bremerhaven with excellent rail connections throughout Germany.
              </p>
      ...
      <section className="py-12 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-ocean mb-1">28-40</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                Why Choose Sea Freight to Germany?
              </h2>
              <p className="text-muted-foreground mb-8">
                Germany is the heart of European manufacturing and trade.
                Sea freight offers the most cost-effective solution for shipping large volumes.
                We also offer China-Europe rail freight for faster transit when needed.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Major German Destination Ports
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We ship to all major German ports with excellent rail and road connections throughout Europe.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
              All Sea Freight Routes to Germany
            </h2>
            <p className="text-muted-foreground">
              Browse all {seaRoutes.length} sea freight routes from China to Germany.
            </p>
          </div>
      ...
      <CTASection
        variant="gradient"
        title="Ship by Sea to Germany Today"
        description="Get a free quote for sea freight from China to Germany. EU customs expertise included."
      />
    </>
  );
}
