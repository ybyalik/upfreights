...
export const countryDestinations: CountryDestination[] = [
  ...
  },
  {
    ...
    name: 'Sweden',
    code: 'SE',
    description: 'Professional freight forwarding from China to Sweden with reliable services to major Swedish ports.',
  ...
  },
  {
    ...
    name: 'Norway',
    code: 'NO',
    description: 'Professional freight forwarding from China to Norway with services to 18 Norwegian ports.',
  ...
  },
  {
    ...
    name: 'Czech Republic',
    code: 'CZ',
    description: 'Professional freight forwarding from China to Czech Republic via inland terminals at Paskov and Melnik.',
