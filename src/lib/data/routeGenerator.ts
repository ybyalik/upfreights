...
const seaOrigins = [
  ...
  { city: 'Dalian', port: 'Port of Dalian (CNDLC)', code: 'CNDLC' },
];
...
const allDestinations: Record<string, { city: string; seaPort?: string; airPort?: string; country: string; countrySlug: string; seaTransit?: string; airTransit?: string }> = {
  ...
  'wilmington': { city: 'Wilmington, NC', seaPort: 'Port of Wilmington (USILM)', airPort: 'Wilmington Airport (ILM)', country: 'United States', countrySlug: 'china-to-united-states', seaTransit: '28-32', airTransit: '3-5' },
  ...
  'teesport': { city: 'Teesport', seaPort: 'Port of Teesport (GBTES)', country: 'United Kingdom', countrySlug: 'china-to-united-kingdom', seaTransit: '30-35' },
  'belfast': { city: 'Belfast', seaPort: 'Port of Belfast (GBBEL)', country: 'United Kingdom', countrySlug: 'china-to-united-kingdom', seaTransit: '32-37' },
  'grangemouth': { city: 'Grangemouth', seaPort: 'Port of Grangemouth (GBGRG)', country: 'United Kingdom', countrySlug: 'china-to-united-kingdom', seaTransit: '30-35' },
  'liverpool': { city: 'Liverpool', seaPort: 'Port of Liverpool (GBLIV)', country: 'United Kingdom', countrySlug: 'china-to-united-kingdom', seaTransit: '30-35' },
  'south-shields': { city: 'South Shields', seaPort: 'Port of Tyne, South Shields (GBSSH)', country: 'United Kingdom', countrySlug: 'china-to-united-kingdom', seaTransit: '30-35' },
  // Australia
  ...
  // Italy
  'trieste': { city: 'Trieste', seaPort: 'Port of Trieste (ITTRS)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'naples': { city: 'Naples', seaPort: 'Port of Naples (ITNAP)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '50-65' },
  'la-spezia': { city: 'La Spezia', seaPort: 'Port of La Spezia (ITSPE)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'venice': { city: 'Venice', seaPort: 'Port of Venice (ITVCE)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'genoa': { city: 'Genoa', seaPort: 'Port of Genoa (ITGOA)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'ancona': { city: 'Ancona', seaPort: 'Port of Ancona (ITAON)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },

  'cagliari': { city: 'Cagliari', seaPort: 'Port of Cagliari (ITCAG)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'civitavecchia': { city: 'Civitavecchia', seaPort: 'Port of Civitavecchia (ITCVV)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'livorno': { city: 'Livorno', seaPort: 'Port of Livorno (ITLIV)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'ravenna': { city: 'Ravenna', seaPort: 'Port of Ravenna (ITRAN)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'salerno': { city: 'Salerno', seaPort: 'Port of Salerno (ITSAL)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  // Sweden
  'gothenburg': { city: 'Gothenburg', seaPort: 'Port of Gothenburg (SEGOT)', country: 'Sweden', countrySlug: 'china-to-sweden', seaTransit: '30-35' },
  'helsingborg': { city: 'Helsingborg', seaPort: 'Port of Helsingborg (SEHEL)', country: 'Sweden', countrySlug: 'china-to-sweden', seaTransit: '32-37' },
  'norrkoeping': { city: 'Norrkoeping', seaPort: 'Port of Norrkoeping (SENRK)', country: 'Sweden', countrySlug: 'china-to-sweden', seaTransit: '33-38' },
  'gaevle': { city: 'Gaevle', seaPort: 'Port of Gaevle (SEGVX)', country: 'Sweden', countrySlug: 'china-to-sweden', seaTransit: '34-39' },
  'halmstad': { city: 'Halmstad', seaPort: 'Port of Halmstad (SEHAD)', country: 'Sweden', countrySlug: 'china-to-sweden', seaTransit: '32-37' },
  // Czech Republic
  'awt-paskov': { city: 'Awt Paskov', seaPort: 'AWT Terminal Paskov (CZPAS)', country: 'Czech Republic', countrySlug: 'china-to-czech-republic', seaTransit: '35-42' },
  'melnik': { city: 'Melnik', seaPort: 'Port of Melnik (CZMEL)', country: 'Czech Republic', countrySlug: 'china-to-czech-republic', seaTransit: '35-42' },
  // Norway
  'drammen': { city: 'Drammen', seaPort: 'Port of Drammen (NODRM)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'oslo': { city: 'Oslo', seaPort: 'Port of Oslo (NOOSL)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'aalesund': { city: 'Aalesund', seaPort: 'Port of Aalesund (NOAAL)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '33-38' },
  'bergen': { city: 'Bergen', seaPort: 'Port of Bergen (NOBGO)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'brevik': { city: 'Brevik', seaPort: 'Port of Brevik (NOBRV)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '33-38' },
  'floroe': { city: 'Floroe', seaPort: 'Port of Floroe (NOFRO)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '33-38' },
  'fredrikstad': { city: 'Fredrikstad', seaPort: 'Port of Fredrikstad (NOFRD)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'haugesund': { city: 'Haugesund', seaPort: 'Port of Haugesund (NOHAU)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '33-38' },
  'kristiansand': { city: 'Kristiansand', seaPort: 'Port of Kristiansand (NOKRS)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'larvik': { city: 'Larvik', seaPort: 'Port of Larvik (NOLAR)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'maaloey': { city: 'Maaloey', seaPort: 'Port of Maaloey (NOMAY)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '33-38' },
  'moss': { city: 'Moss', seaPort: 'Port of Moss (NOMSS)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'mo-i-rana': { city: 'Mo I Rana', seaPort: 'Port of Mo I Rana (NOMQN)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '35-40' },
  'orkanger': { city: 'Orkanger', seaPort: 'Port of Orkanger (NOORK)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '34-39' },
  'straumen': { city: 'Straumen', seaPort: 'Port of Straumen (NOSTR)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '35-40' },
  'stavanger': { city: 'Stavanger', seaPort: 'Port of Stavanger (NOSVG)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '32-37' },
  'svelgen': { city: 'Svelgen', seaPort: 'Port of Svelgen (NOSVL)', country: 'Norway', countrySlug: 'china-to-norway', seaTransit: '33-38' },
};

// Define exact sea freight routes from existing site (259 total)
const seaRouteMatrix: Record<string, string[]> = {
  'shanghai': ['los-angeles', 'long-beach', 'new-york', 'oakland', 'seattle', 'tacoma', 'savannah', 'houston', 'dallas', 'salt-lake-city', 'charleston', 'norfolk', 'jacksonville', 'wilmington', 'atlanta', 'boston', 'chicago', 'denver', 'miami', 'san-francisco', 'vancouver', 'toronto', 'montreal', 'halifax', 'calgary', 'prince-rupert', 'ottawa', 'regina', 'winnipeg', 'felixstowe', 'southampton', 'london-gateway', 'london', 'teesport', 'belfast', 'grangemouth', 'liverpool', 'south-shields', 'sydney', 'melbourne', 'brisbane', 'fremantle', 'hamburg', 'bremerhaven', 'rotterdam', 'trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'cagliari', 'civitavecchia', 'livorno', 'ravenna', 'salerno', 'gothenburg', 'helsingborg', 'norrkoeping', 'gaevle', 'halmstad', 'awt-paskov', 'melnik', 'drammen', 'oslo', 'aalesund', 'bergen', 'brevik', 'floroe', 'fredrikstad', 'haugesund', 'kristiansand', 'larvik', 'maaloey', 'moss', 'mo-i-rana', 'orkanger', 'straumen', 'stavanger', 'svelgen'],
  'shenzhen': ['los-angeles', 'long-beach', 'new-york', 'oakland', 'seattle', 'tacoma', 'savannah', 'houston', 'dallas', 'salt-lake-city', 'charleston', 'norfolk', 'jacksonville', 'atlanta', 'boston', 'san-francisco', 'vancouver', 'toronto', 'montreal', 'halifax', 'calgary', 'prince-rupert', 'ottawa', 'regina', 'winnipeg', 'felixstowe', 'southampton', 'london-gateway', 'teesport', 'belfast', 'grangemouth', 'liverpool', 'south-shields', 'sydney', 'melbourne', 'brisbane', 'fremantle', 'hamburg', 'bremerhaven', 'frankfurt', 'munich', 'rotterdam', 'trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'cagliari', 'civitavecchia', 'livorno', 'ravenna', 'salerno', 'gothenburg', 'helsingborg', 'norrkoeping', 'gaevle', 'halmstad', 'awt-paskov', 'melnik', 'drammen', 'oslo', 'aalesund', 'bergen', 'brevik', 'floroe', 'fredrikstad', 'haugesund', 'kristiansand', 'larvik', 'maaloey', 'moss', 'mo-i-rana', 'orkanger', 'straumen', 'stavanger', 'svelgen'],
  'guangzhou': ['los-angeles', 'long-beach', 'new-york', 'oakland', 'seattle', 'tacoma', 'savannah', 'houston', 'dallas', 'salt-lake-city', 'charleston', 'norfolk', 'jacksonville', 'atlanta', 'boston', 'chicago', 'denver', 'miami', 'san-francisco', 'vancouver', 'toronto', 'montreal', 'halifax', 'calgary', 'prince-rupert', 'ottawa', 'regina', 'winnipeg', 'felixstowe', 'southampton', 'london-gateway', 'london', 'teesport', 'belfast', 'grangemouth', 'liverpool', 'south-shields', 'sydney', 'melbourne', 'brisbane', 'fremantle', 'hamburg', 'bremerhaven', 'munich', 'rotterdam', 'trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'cagliari', 'civitavecchia', 'livorno', 'ravenna', 'salerno', 'gothenburg', 'helsingborg', 'norrkoeping', 'gaevle', 'halmstad', 'awt-paskov', 'melnik', 'drammen', 'oslo', 'aalesund', 'bergen', 'brevik', 'floroe', 'fredrikstad', 'haugesund', 'kristiansand', 'larvik', 'maaloey', 'moss', 'mo-i-rana', 'orkanger', 'straumen', 'stavanger', 'svelgen'],
  ...
  'dalian': ['trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'cagliari', 'civitavecchia', 'livorno', 'ravenna', 'salerno', 'gothenburg', 'helsingborg', 'norrkoeping', 'gaevle', 'halmstad', 'awt-paskov', 'melnik', 'teesport', 'belfast', 'grangemouth', 'liverpool', 'south-shields', 'drammen', 'oslo', 'aalesund', 'bergen', 'brevik', 'floroe', 'fredrikstad', 'haugesund', 'kristiansand', 'larvik', 'maaloey', 'moss', 'mo-i-rana', 'orkanger', 'straumen', 'stavanger', 'svelgen'],
};
...
const popularGoodsByCountry: Record<string, string[]> = {
  ...
  'italy': ['Machinery', 'Electronics', 'Textiles', 'Fashion Goods', 'Consumer Products'],
  'sweden': ['Machinery', 'Electronics', 'Consumer Goods', 'Furniture', 'Automotive Parts'],
  'czech-republic': ['Machinery', 'Electronics', 'Automotive Parts', 'Consumer Goods', 'Industrial Equipment'],
  'norway': ['Machinery', 'Electronics', 'Consumer Goods', 'Marine Equipment', 'Industrial Supplies'],
};
