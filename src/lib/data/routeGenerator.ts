...
const seaRouteMatrix: Record<string, string[]> = {
  ...
  'hong-kong': ['los-angeles', 'long-beach', 'new-york', 'oakland', 'seattle', 'tacoma', 'savannah', 'houston', 'dallas', 'salt-lake-city', 'charleston', 'norfolk', 'jacksonville', 'vancouver', 'toronto', 'montreal', 'halifax', 'calgary', 'prince-rupert', 'regina', 'winnipeg', 'felixstowe', 'southampton', 'london-gateway', 'sydney', 'melbourne', 'brisbane', 'fremantle', 'hamburg', 'bremerhaven', 'rotterdam', 'trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'cagliari', 'civitavecchia', 'livorno', 'ravenna', 'salerno'],
  'dalian': ['trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'cagliari', 'civitavecchia', 'livorno', 'ravenna', 'salerno'],
};
