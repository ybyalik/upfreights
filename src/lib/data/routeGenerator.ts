...
const allDestinations: Record<string, { city: string; seaPort?: string; airPort?: string; country: string; countrySlug: string; seaTransit?: string; airTransit?: string }> = {
  ...
  'ancona': { city: 'Ancona', seaPort: 'Port of Ancona (ITAOI)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  'genoa-vado-ligure': { city: 'Genoa Vado Ligure', seaPort: 'Port of Vado Ligure (ITVDL)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
  ...
  'leghorn': { city: 'Leghorn', seaPort: 'Port of Livorno (ITLIV)', country: 'Italy', countrySlug: 'china-to-italy', seaTransit: '40-65' },
...
const seaRouteMatrix: Record<string, string[]> = {
  ...
  'hong-kong': ['los-angeles', 'long-beach', 'new-york', 'oakland', 'seattle', 'tacoma', 'savannah', 'houston', 'dallas', 'salt-lake-city', 'charleston', 'norfolk', 'jacksonville', 'vancouver', 'toronto', 'montreal', 'halifax', 'calgary', 'prince-rupert', 'regina', 'winnipeg', 'felixstowe', 'southampton', 'london-gateway', 'sydney', 'melbourne', 'brisbane', 'fremantle', 'hamburg', 'bremerhaven', 'rotterdam', 'trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'genoa-vado-ligure', 'cagliari', 'civitavecchia', 'leghorn', 'ravenna', 'salerno'],
  'dalian': ['trieste', 'naples', 'la-spezia', 'venice', 'genoa', 'ancona', 'genoa-vado-ligure', 'cagliari', 'civitavecchia', 'leghorn', 'ravenna', 'salerno'],
};
